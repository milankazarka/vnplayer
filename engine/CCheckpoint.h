...
//  IAApp
//
//  Created by Milan Kazarka on 10/27/14.
...
#ifndef __IAApp__CCheckpoint__
#define __IAApp__CCheckpoint__
...
public:
    TiXmlElement *mecheckpoint;
    
    CCheckpoint( TiXmlElement *echeckpoint );
};

#endif /* defined(__IAApp__CCheckpoint__) */
